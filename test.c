...
//>gcc -o tst crc32.c zutil.c  test.c -DHAS_PCLMUL -march=native; ./tst
// Conversion required 0.314882 seconds.
// CRC= 4062621372
//>gcc -o tst crc32.c zutil.c  test.c -march=native; ./tst
// Conversion required 3.668909 seconds.
// CRC= 4062621372
//crc >gcc -o tst crc32.c zutil.c  test.c -DHAS_PCLMUL -march=native; ./tst
